...
def _tf_pip_impl(repository_ctx):
  ...
  tf_header_rule = _symlink_genrule_for_dir(
      repository_ctx, tf_header_dir, 'include', 'tf_header_include')
  ...
  tf_shared_library_rule = _symlink_genrule_for_dir(
      repository_ctx, None, '', 'libtensorflow_framework.so', [tf_shared_library_path], ['libtensorflow_framework.so'])
